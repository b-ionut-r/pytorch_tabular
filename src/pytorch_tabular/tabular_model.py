        ...
        **kwargs,
        ...
        for fold, (train_idx, val_idx) in it:
            ...
            if feature_generator is not None:
                ...
                # Apply feature generator - fit on train, transform on BOTH for consistency
                feature_generator.fit(X_train_fold, y_train_fold)
                X_train_transformed = feature_generator.transform(X_train_fold)
